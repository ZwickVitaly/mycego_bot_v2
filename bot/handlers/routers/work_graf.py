...
@work_graf_router.callback_query(WorkGraf.choice_time, F.data.startswith("back"))
...
@work_graf_router.callback_query(WorkGraf.choice_time2, F.data.startswith("back"))
